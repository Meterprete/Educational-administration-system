...
'''
    需要分别伪造两个请求：
        1. post: http://jwgl.wfust.edu.cn/znpk/Pri_StuSel_rpt.aspx?m=hx79BA3fYPqqkLT
...
class Climb_to_God:
    def __init__(self):
        self.url_1 = "http://jwgl.wfust.edu.cn/znpk/Pri_StuSel_rpt.aspx?m=hx79BA3fYPqqkLT"
        ...
        self.data = {
            ...
            "px": "0",
            "txt_yzm": "",
            "hidyzm": "4a19741e062dea806e6b3b9cf3392ez",
            "hidsjyzm": "08159D3BDA6FA00B51FACB89587522B5"
        }
